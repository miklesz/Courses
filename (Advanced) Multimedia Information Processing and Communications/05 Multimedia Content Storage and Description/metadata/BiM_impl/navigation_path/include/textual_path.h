...
class textual_path{
	static char txt_path[1000];
public:
	static void write_textual_path(int mode);
	static void read_textual_path(int type_of_path,const char *textual, int mode);
	static char *get_textual_path();
};
