...
public class GlobalGroupHandler extends GroupHandler {
    ...
    public  void init(String uri, String local, String raw, Attributes attrs) throws HandlerException {
        try{
            ...
            // in case of group
            group = new GlobalGroup(attrs.getValue(SchemaSymbols.ATT_NAME));
            // ref to a group in a complexType
            group.setRefName(getResolvedName(attrs.getValue(SchemaSymbols.ATT_REF)));
            // the min Occur
