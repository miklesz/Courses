...
public class DocumentationHandler extends StaticLocalHandler {
    ...
    public void init(String uri, String local, String raw, Attributes attrs){
            documentation.setSource(attrs.getValue(SchemaSymbols.ATT_SOURCE));
    ...
    public  void characters(char[] ch, int start, int length){
        documentation.setValue(new String(ch,start,length));
    }
