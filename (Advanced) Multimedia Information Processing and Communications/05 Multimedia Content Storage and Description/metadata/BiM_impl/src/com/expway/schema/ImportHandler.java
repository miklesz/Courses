...
public class ImportHandler extends StaticLocalHandler {

    String [] importation = new String[2];
    ...
    public void init(String uri, String local, String raw, Attributes attrs){
            importation[0] = attrs.getValue(SchemaSymbols.ATT_NAMESPACE);
            importation[1] = attrs.getValue(SchemaSymbols.ATT_SCHEMALOCATION);
