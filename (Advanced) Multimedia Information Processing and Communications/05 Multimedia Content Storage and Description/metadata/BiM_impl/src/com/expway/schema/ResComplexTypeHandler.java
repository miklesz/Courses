...
public class ResComplexTypeHandler extends CommonComplexTypeHandler 
    implements ExtResInterface{
   
    public String getTypeDerivation() {return ExtResInterface.TYPE_RESTRICTION;}
    ...
    public  void init(String uri, String local, String raw, Attributes attrs)
        ...
        try{
            ...
            complexType.setDerived(SchemaSymbols.ATTVAL_RESTRICTION);
