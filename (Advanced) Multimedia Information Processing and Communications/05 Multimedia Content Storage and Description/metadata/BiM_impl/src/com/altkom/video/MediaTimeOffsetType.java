...
public class MediaTimeOffsetType extends BasicMedia
{
   public MediaTimeOffsetType()
   {
      super(1023); //from pattern this should be probably 1014 like in MediaDuration
   }

   public MediaTimeOffsetType(String content)
   {
      super(1023, content); //from pattern this should be probably 1014 like in MediaDuration
   }

   public void writeInto(ChunkWriter cw) throws IOException
   {
      (new BasicDurationDataType("TimeOffset", "mediaTimeOffsetType", repr)).
                                                                        encodeItInto(content, cw);
   }

   void readContentFrom(BitToBitDataInputStream dis, Writer w) throws IOException
   {
      (new BasicDurationDataType("TimeOffset", "mediaTimeOffsetType", repr)).decode(dis, w);
   }
