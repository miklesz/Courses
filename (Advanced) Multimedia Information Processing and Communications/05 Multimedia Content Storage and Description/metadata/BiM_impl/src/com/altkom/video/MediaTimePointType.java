...
import com.siemens.BasicTimePointDataType;

import java.io.Writer;
import java.io.IOException;

public class MediaTimePointType extends BasicMedia
{
   public MediaTimePointType()
   {
      super(1982);
   }

   public MediaTimePointType(String content)
   {
      super(1982, content);
   }

   public void writeInto(ChunkWriter cw)
   {
      (new BasicTimePointDataType("TimePoint", "mediaTimePointType", repr)).
                                                                        encodeItInto(content, cw);
   }

   void readContentFrom(BitToBitDataInputStream dis, Writer w) throws IOException
   {
      (new BasicTimePointDataType("TimePoint", "mediaTimePointType", repr)).decode(dis, w);
   }
